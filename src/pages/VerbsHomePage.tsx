  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Verb Forms</h1>
          <p className="text-sm text-gray-500 mt-1">Practice irregular verbs — V1, V2, V3</p>
        </div>
      ...
      {lists.length === 0 ? (
        <EmptyState
          title="No verb lists yet"
          description="Create your first list to start practising irregular verbs."
      ...
      {showCreate && (
        ...
        >
          <input
            autoFocus
            type="text"
            placeholder="e.g. Irregular Verbs — Set 1"
